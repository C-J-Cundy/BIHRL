...
# Running the MCMC will dump the results into the working directory. The
# main plotter takes in a list of the directories where the results are:
# you have to put the data in there yourself.
...
def MCMC(O_a_list, Os, beta, g, n, seed=0, n_burn=0, gO_s=None):
    ...
    if Os == gen_option_set([0, 15]):
        np.save(
            "./data/option_chain_" + str(seed) + "_" + str(beta), marginals[:, n_burn:]
        )
    else:
        np.save(
            "./data/irl_chain_" + str(seed) + "_" + str(beta), marginals[:, n_burn:]
        )
...
def multipool_MCMC_spec_options(
    ...
    and then creates a set of n_cores processes, each of which evolve
    separately, doing the standard BIRL (i.e. that we do BHIRL with no
    options). Here we are given some specified options."""
    processes = []
    gO_s = [
        gen_option_trajectories(O_a_list[x], Os, []) for x in range(0, len(O_a_list))
    ]
...
def plot_theta_margs(marg_dirs1, marg_dirs2, betas=[0.1, 0.5, 1.2, 2]):
    ...
    for theta in thetas:
        ...
        (plt_line, cap, barlin) = ax.errorbar(
        ...
        plt_line2, cap2, barlin2 = ax.errorbar(
...
def plot_bar():
    ...
    results = [
        [0.0679, 0.032, 0.0354, 0.045, 0.0169],
        [0.10892, 0.08872, 0.187, 0.2136, 0.2189],
    ]
    errors = [
        [0.011, 0.0044, 0.0049, 0.00627, 0.00264],
...
if __name__ == "__main__":
    ...
    #         multipool_MCMC(O_as, b, 0.999, 4000, 16, False)
    # else:
    #     for b in [0.1, 0.3, 0.5, 0.8, 1.2, 1.6, 2]:
    #         options_multipool_MCMC(O_as, b, 0.999, 4000, 16, False)
    ...
    if sys.argv[1] == "birl":
        ...
        plot_theta_margs(
            [
                "./data_newest/line_graph/b_o_0.1",
                "./data_newest/line_graph/b_o_0.3",
                "./data_newest/line_graph/b_o_0.5",
                "./data_newest/line_graph/b_o_0.8",
                "./data_newest/line_graph/b_o_1.2",
                "./data_newest/line_graph/b_o_1.6",
                "./data_newest/line_graph/b_o_2",
            ],
            [
                "./data_newest/line_graph/b_0.1",
                "./data_newest/line_graph/b_0.3",
                "./data_newest/line_graph/b_0.5",
                "./data_newest/line_graph/b_0.8",
                "./data_newest/line_graph/b_1.2",
                "./data_newest/line_graph/b_1.6",
                "./data_newest/line_graph/b_2",
            ],
            [0.1, 0.3, 0.5, 0.8, 1.2, 1.6, 2, 1.6],
        )

    #     plot_theta_margs( ['./data/beta_o_0.1', './data/beta_o_0.3', './data/beta_o_0.5', './data/beta_o_0.8',
    #                       './data/beta_o_1.2', './data/beta_o_1.6', './data/beta_o_2'],
    #                       ['./data/beta_mcmc_0.1', './data/beta_mcmc_0.3', './data/beta_mcmc_0.5', './data/beta_mcmc_0.8',
    #                        './data/beta_mcmc_1.2', './data/beta_mcmc_1.6', './data/beta_mcmc_2'],
    #                      [0.1, 0.3, 0.5, 0.8, 1.2, 1.6, 2, 1.6])

    #     plot_theta_margs(['./data/0.1', './data/0.3', './data/0.5', './data/0.8',
    #                       './data/1.2', './data/1.6', './data/2'],
    #                      ['./data/irl_0.1', './data/irl_0.3', './data/irl_0.5', './data/irl_0.8',
    #                       './data/irl_1.2', './data/irl_1.6', './data/irl_2'],
    #                      [0.1, 0.3, 0.5, 0.8, 1.2, 1.6, 2])

    #     plot_theta_margs(['./data/0.1', './data/0.3', './data/0.5', './data/0.8',
    #                       './data/1.2', './data/1.6', './data/2'],
    #                      ['./data/irl_0.1', './data/irl_0.3', './data/irl_0.5', './data/irl_0.8',
    #                       './data/irl_1.2', './data/irl_1.5', './data/irl_2'],
    #                      [0.1, 0.3, 0.5, 0.8, 1.2, 1.6, 2, 1.6])
    ...
    #     plot_theta_margs(['./data/0.8',  './data/1.0',
    #               './data/1.2', './data/1.6', './data/2'],
    #              ['./data/irl_0.8',
    #               './data/irl_1.2', './data/irl_1.6', './data/irl_2'],
    #              [0.8, 1.0, 1.2, 1.6, 2])
